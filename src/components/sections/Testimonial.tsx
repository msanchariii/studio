...
const TestimonialsHeadline = () => (
  <div className="text-center">
    <h2 className="text-4xl font-bold text-gray-800 mb-4">What Our <span className="text-cambridge-darker">Clients</span> Say</h2>
...
const TestimonialCard = ({ t }: { t: TestimonialItem }) => (
  <div
    className="testimonial-card w-full max-w-2xl shrink-0 mr-10
               rounded-tr-2xl rounded-b-2xl bg-white border border-purple-100
               shadow-lg px-6 py-6 text-gray-800
               before:content-[''] before:absolute before:top-[-20px] before:left-0
               before:border-r-[20px] before:border-b-[20px] before:border-r-transparent before:border-b-cambridge
               relative hover:shadow-xl transition-shadow duration-300"
  >
    <div className="flex flex-col gap-4">
      <div className="text-cambridge-darkest font-semibold text-lg">
        {t.name}, {t.position}
      </div>
      <p className="font-bold italic text-gray-700">{t.company}</p>
      <p className="text-sm italic text-gray-600 leading-relaxed">{t.testimonial}</p>
      {t.via && (
...
const Testimonial: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-cambridge-lightest/20">
      <div className="container mx-auto px-6">
        <TestimonialsHeadline />

        <div
          ref={containerRef}
          className="relative mt-16 h-auto overflow-hidden flex items-center cursor-pointer"
          style={{
            maskImage:
        ...
        >
          <div
            ref={trackRef}
            className="flex items-stretch will-change-transform py-6"
